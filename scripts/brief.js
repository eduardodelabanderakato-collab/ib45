...
const C = { ink: '#0e1a33', body: '#2b3446', dim: '#6f7a90', line: '#e3e8f0', bg: '#eef2f7', card: '#ffffff', acc: '#0b7fb0', hi: '#dff4ff', warm: '#1fb6ff', box: '#eef6fb', navy: '#061633' };
...
const img = (src, alt, cap, fb) => `<tr><td style="padding:4px 0 6px"><img src="${src}"${fb ? ` data-fallback="${fb}"` : ''} width="560" alt="${esc(alt)}" style="display:block;width:100%;max-width:560px;height:auto;border:0;border-radius:8px"></td></tr>${cap ? `<tr><td align="center" style="padding:0 0 18px;${font};font-size:12px;color:${C.dim}">(${esc(cap)})</td></tr>` : ''}`;
