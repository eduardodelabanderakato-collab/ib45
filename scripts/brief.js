...
<tr><td style="background:#8C1515;background-image:linear-gradient(90deg,#8C1515 0%,#C8452F 55%,#F5A623 100%);padding:26px 28px;text-align:center"><img src="${SITE}/avatar.png" width="84" height="84" alt="" style="width:84px;height:84px;border-radius:50%;border:3px solid rgba(255,255,255,.85);display:block;margin:0 auto 12px"><div style="font-size:38px;font-weight:800;color:#fff;letter-spacing:-.03em;line-height:1">✈︎ flight deck</div><div style="margin-top:8px;font-size:11px;letter-spacing:.14em;color:rgba(255,255,255,.85);text-transform:uppercase;font-weight:600">Eduardo · IB 45 · Class of 2032</div></td></tr>
